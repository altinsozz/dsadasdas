  ...
  let prefix = (await db.fetch(`prefix_${message.guild.id}`)) || "!";
    ...
    const embed = new Discord.MessageEmbed()
       ...
       .setTitle(` **OneWoo Bot Abone Menüsüne Hoşgeldiniz** `)
        .setDescription(`
  **» <a:yanok:834402207050498058> ${prefix}abone-yetkili-rol**  Premium Komutlarını Gösterir.
  **» <a:yanok:834402207050498058> ${prefix}abone-rol**  Ekonomi Komutlarını Gösterir.
  **» <a:yanok:834402207050498058> ${prefix}abone-log**  Gif Komutlarını Gosterir.
  **» <a:yanok:834402207050498058> ${prefix}abone**  Moderasyon Komutlarını Gösterir.
`)
